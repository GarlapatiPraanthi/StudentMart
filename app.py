...
def search():
    ...
    results_query = Listing.query.filter(Listing.sold == False)  # Exclude sold items
    ...
    # Serialize results using ProductSchema
    ...
    return render_template('BuyPage.html', data=results2, filters_applied=True)
